...
/**
 * GET /api/invoices/{id}/advance-candidates
 *
 * Vrátí nespárované zálohové faktury (invoice_type='proforma') stejného odběratele,
 * které lze propojit s tímto daňovým dokladem.
 */
